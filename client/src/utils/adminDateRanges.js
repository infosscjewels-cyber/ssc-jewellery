export const DEFAULT_ADMIN_QUICK_RANGE = 'current_month';
export const DEFAULT_ADMIN_ABANDONED_RANGE = 'current_month';

export const ADMIN_QUICK_RANGES = [
...
export const ADMIN_ABANDONED_RANGE_OPTIONS = [
    { value: 'current_week', label: 'Current Week' },
    { value: 'current_month', label: 'Current Month' },
    { value: 'last_3_months', label: 'Last 3 Months' },
...
export const normalizeAdminQuickRange = (value, { fallback = DEFAULT_ADMIN_QUICK_RANGE } = {}) => {
...
export const normalizeAbandonedRangeValue = (value, { fallback = DEFAULT_ADMIN_ABANDONED_RANGE } = {}) => {
    const raw = String(value ?? '').trim().toLowerCase();
...
export const resolveNamedDateRange = (value, { now = new Date() } = {}) => {
